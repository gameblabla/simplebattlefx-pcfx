...
CFLAGS        += -I$(V810GCC)/include/ -I$(V810GCC)/$(PREFIX)/include/ -Ofast -Wall -std=gnu99 -mv810 -msda=256 -mprolog-function
CPFLAGS       += -I$(V810GCC)/include/ -I$(V810GCC)/$(PREFIX)/include/ -Ofast -Wall -std=gnu++11 -fno-rtti -fno-exceptions -mv810 -msda=256 -mprolog-function 
